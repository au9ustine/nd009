...
<head>
    ...
    <link href="/content/v/4e3f994e938b/kaggle/favicon.ico" rel="shortcut icon" type="image/x-icon" />
        ...
        <meta name="keywords" content="Kaggle, data science, datasets, public data, crowdsourced analytics, competitions, tutorials, scripts, Python, R, InClass, jobs board" />
            ...
            <link rel="stylesheet" href="/content/v/062b118a1d9e/shared/css/base.less" type="text/css" />
...
<input name="__RequestVerificationToken" type="hidden" value="RMCeoWt-TxgXevRY7qoel2mPeBerj7ZeC5a3PJiBDPkvRdMrUCp4vUAAW8Z3B0yTGziVr_oDAHUrfgq3xO2d9u-P1_I1" />    <input id="signinjs" type="hidden" name="JavaScriptEnabled" value="false" />    
</form>
<script type="text/javascript">
